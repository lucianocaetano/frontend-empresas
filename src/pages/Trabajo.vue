            ...
            <q-card-section>
              <div v-if="step === 0">
                ...
                <div class="row">
                  <q-input
                    class="col-6"
                    v-model="newActividad.fechaInicio"
                    label="Fecha Inicio"
                    type="date"
                  />
                  <q-input
                    class="col-6"
                    v-model="newActividad.fechaFin"
                    label="Fecha Fin"
                    type="date"
                  />
                </div>
              ...
              <div class="col-12" v-if="step === 1">
                <div>
                  <q-checkbox
                    v-model="newActividad.confirmacionEmpresa"
                    label="¿Esta empresa, confirmó el trabajo?"
                    style="display: block"
                  />
                </div>
                <div class="col-6" style="display: inline-block; width: 50%">
                  <q-checkbox
                    v-model="newActividad.solicitarCI"
                    label="Solicitar CI"
                    style="display: block"
                  />

                  <q-checkbox
                    v-model="newActividad.solicitarBPS"
                    label="Solicitar BPS"
                    style="display: block"
                  />

                  <q-checkbox
                    v-model="newActividad.solicitarBSE"
                    label="Solicitar BSE"
                    style="display: block"
                  />

                  <q-checkbox
                    v-model="newActividad.solicitarInduccionSeguridad"
                    label="Solicitar Inducción de Seguridad"
                    style="display: block"
                  />

                  <q-checkbox
                    v-model="newActividad.permisoTrabajoEnCaliente"
                ...
                <div class="col-6" style="display: inline-block; width: 50%">
                  <q-checkbox
                    v-model="newActividad.permisoTrabajoEnAltura"
                    label="Permiso de trabajo en altura"
                    style="display: block"
                  />

                  <q-checkbox
                    v-model="newActividad.permisoTrabajoEnEspacioConfinado"
                    label="Permiso de trabajo en espacio confinado"
                    style="display: block"
                  />

                  <q-checkbox
                    v-model="newActividad.permisoTrabajoOtros"
                    label="Otros permisos de trabajo"
                    style="display: block"
                  />

                  <q-checkbox
                    v-model="newActividad.solicitarEntregaEPP"
                    label="Entrega EPP"
                    style="display: block"
                  />
                </div>
